...
import com.downloader.loader.FtpLoader;
import com.downloader.loader.HttpLoader;
...
public class LoaderTest {
    ...
    public void downloadHttpFileSuccess() throws Exception{
        ...
        String savePath = "/Users/khwanchanok/Downloads/output.zip";
    ...
    public void downloadFtpFileSuccess() throws Exception {
        ...
        String savePath = "/Users/khwanchanok/Downloads/output.md";
